print("NOTE: I'm very familiar with this level of python so this was solved before I read the chapter.")


print("""\n\n=== Question 2 ===
Write a program that uses input to prompt a user for name and then welcomes them.
